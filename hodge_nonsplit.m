...
intrinsic HodgeDataNonsplit(Q::RngUPolElt[RngUPol], g::RngIntElt, W0::AlgMatElt[FldFunRat], basis::SeqEnum[ModTupRngElt[RngUPol]],
  ...
  //time split := Compositum(split, split_new);
    //end if;
  //end for;
